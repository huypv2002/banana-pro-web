...
Chạy trên VPS: python test_generate.py
"""
import sys, os
...
os.environ["CHROME_PROFILE_PATH"] = CHROME_PROFILE
...
print(f"Token OK: {ok}, token: {getattr(client, 'access_token', None) and client.access_token[:30]}...")
